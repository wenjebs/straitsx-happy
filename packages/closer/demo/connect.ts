 ...
 *
 *   pnpm --filter @happy/closer connect https://shopee.sg
 *
 ...
 * `pnpm --filter @happy/closer disconnect <host>` deletes it.
 */
import { createProfileStore } from "../src/profiles.js";

const url = process.argv[2];
if (!url) {
  console.error("usage: pnpm --filter @happy/closer connect <url>");
  process.exit(1);
}
